export const ecosystemGroups = [
  ...
  },
  {
    ...
    title: 'Chess',
    icon: '♞',
    description: 'Tools for chess study, training, audio learning and mnemonic practice.',
    projects: [
      {
        id: 'chess-flashcards',
  ...
  },
  {
    ...
    icon: '▣',
    description: 'Practical resources for a cleaner and more organized digital environment.',
    projects: [
      {
        id: 'organize-your-pc',
  ...
  },
  {
    ...
    title: 'Entertainment',
    icon: '◈',
    description: 'Interactive digital experiences designed for exploration and discovery.',
    projects: [
      {
        id: 'animals-within',
  ...
  },
  {
    ...
    title: 'Meditation',
    icon: '≋',
    description: 'Calming soundscapes for rest, focus, meditation and quiet moments.',
    projects: [
      {
        id: 'relaxing-sounds',
  ...
  },
  {
    ...
    icon: '⌂',
    description: 'Applications for structured study, active recall and memory development.',
    projects: [
      {
        id: 'study-app',
        title: 'StudyApp',
